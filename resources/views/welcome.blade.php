...
@section('content')
    <div class="container mx-auto text-center py-12">
        <h1 class="text-4xl font-bold text-blue-600">Bienvenue sur notre site d'apprentissage</h1>
        ...
        <div class="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div class="bg-white shadow-lg rounded-lg p-6">
                <h2 class="text-xl font-semibold text-blue-600">Nos Cours</h2>
            ...
            <div class="bg-white shadow-lg rounded-lg p-6">
                <h2 class="text-xl font-semibold text-blue-600">À propos de nous</h2>
            ...
            <div class="bg-white shadow-lg rounded-lg p-6">
                <h2 class="text-xl font-semibold text-blue-600">Contactez-nous</h2>
        ...
        <div class="mt-12">
            <h2 class="text-2xl font-bold text-blue-600">Rejoignez-nous dès aujourd'hui !</h2>
            ...
            <a href="/register" class="mt-4 inline-block bg-green-600 text-white py-2 px-6 rounded hover:bg-green-700">S'inscrire maintenant</a>
        </div>
    </div>
@endsection
